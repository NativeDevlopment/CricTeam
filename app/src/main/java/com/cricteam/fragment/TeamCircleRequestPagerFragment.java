 ...
 * Use the {@link TeamCircleRequestPagerFragment#newInstance} factory method to
 * create an instance of this fragment.
 */
public class TeamCircleRequestPagerFragment extends Fragment {
    ...
    private NotificationAdapter findTeamAdapter;
    private TextView progressLabel;
    private boolean isPage=true;

    public TeamCircleRequestPagerFragment() {
    ...
    public static TeamCircleRequestPagerFragment newInstance(String param1, String param2) {
        TeamCircleRequestPagerFragment fragment = new TeamCircleRequestPagerFragment();
    ...
    private void setAdapter() {
        ...
        findTeamAdapter = new NotificationAdapter(mContext, searchTeams);
