...
abstract class ImageViewTouchBase extends ImageView {
    ...
    private void setImageBitmap(Bitmap bitmap, int rotation) {
        ...
        if (d != null) {
            d.setDither(true); // TODO :  This method was deprecated in API level 23. This property is ignored.
        }
    ...
    public void setImageRotateBitmapResetBase(@NonNull final RotateBitmap bitmap,
                                              final boolean resetSupp) {
    ...
    private void getProperBaseMatrix(@NonNull RotateBitmap bitmap, @NonNull Matrix matrix) {
        ...
        matrix.postTranslate(
                (viewWidth - w * scale) / 2.0F,
                (viewHeight - h * scale) / 2.0F);
    }
